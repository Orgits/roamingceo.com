                    ...
                    <div className="container single-content">
                        ...
                        <article className="entry-wraper mb-50">
                            ...
                            <div className="entry-main-content">
                                ...
                                <h2>Links</h2>
                                <p>If you paste in a URL, like <a href="https://orgits.in">https://orgits.in</a> - it'll automatically be linked up. But if you want to customise your anchor text, you can do that too! Here's a link to <a href="https://orgits.in">the Orgits website.</a></p>
                                <hr className="wp-block-separator" />
                                <h2>Blockquotes</h2>
